...
serco_virtual = turtle.Turtle()
serco_virtual.hideturtle()
serco_virtual.penup()
serco_virtual.goto(-120.5167, 35.5833 )
for i in range (4):
    serco_virtual.pendown()
    serco_virtual.fd(50)
    serco_virtual.right(90)
